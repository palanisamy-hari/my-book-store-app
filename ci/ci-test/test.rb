...
def launch_browser(browser_type = 'chrome', remote = false, headless = false)
  ...
  remote_url = ENV['SELENIUM_GRID_HOST'] ||= "http://localhost:4444/"
  browser_opts = {
    accept_insecure_certs: true,
    page_load_timeout: 100,
    script_timeout: 30,
    'useAutomationExtension': false,
    args: ['--disable-extensions --disable-cache --ignore-certificate-errors --disable-popup-blocking --disable-translate --start-maximized'],
    detach: true
  }
  ...
  @browser = case browser_type.downcase
             ...
             when 'chrome_remote'
               Watir::Browser.new :chrome, url: remote_url, options: browser_opts
             when 'firefox_remote'
...
@browser = launch_browser 'chrome_remote', true, false
